...
public class Content extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.txt_content)).setText(Html.fromHtml(mParam1));
        ((ImageButton)view.findViewById(R.id.btn_back)).setOnClickListener(new View.OnClickListener() {
            @Override
